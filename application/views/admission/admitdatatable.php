  ...
  <div class="card-header pb-0 pt-3">
    ...
    <div class="d-flex justify-content-between">
      ...
      <div class="mb-2 text-gray-800">
        <h5><strong>Patient Records Table</strong></h5>
      </div>
      
      <div class="">
        <a href="<?php echo base_url(); ?>admissioncontrol/opd_form">
          <i class="fa fa-plus text-secondary"></i>
        </a>
      </div>

      <div class="hidden disabled">
        <h5 style="color: rgba(0,0,0,0);"><strong>Patient Records Table</strong></h5>
      </div>
