  ...
  <div class="col-lg-4">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success">PERSONAL INFORMATION <?php echo "<a style='margin-left: 225px; text-decoration:none;' class='text-secondary' href='" . base_url() . "admissioncontrol/patient_edit_option/" . $get_findings_view->pr_id . "'>" ?>
      ...
      <div class="card-body">
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_devstage; ?></div>
        </div>
        ...
        <div style="margin-bottom:18px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_nationality; ?></div>
        </div>
        ...
        <div style="margin-bottom:18px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_height; ?></div>
        </div>
        ...
        <div style="margin-bottom:18px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_weight; ?></div>
        </div>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-2 pt-3">
        ...
        <div class="d-flex justify-content-between">
          ...
          <div class="">
            <?php echo "<a style='text-decoration:none;' class='text-secondary' href='" . base_url() . "admissioncontrol/patient_edit_option/" . $get_findings_view->pr_id . "'>" ?>
      ...
      <div class="card-body">
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_grdnname; ?></div>
        </div>
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_grdnemail; ?></div>
        </div>
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_grdnrelation; ?></div>
        </div>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_schname; ?></div>
        </div>
        ...
        <div style="margin-bottom:17px;">
          ...
          <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_schaddress; ?></div>
        </div>
  ...
  <div id="findings" class="col-xl-8 col-lg-4">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-success">OPD Findings <?php echo "<a style='margin-left: 530px; text-decoration:none;' class='text-secondary' href='" . base_url() . "admissioncontrol/findingsview/" . $get_findings_view->findings_id . "#findings'>" ?> <i class="fa 
