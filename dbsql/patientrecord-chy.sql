...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2022 at 12:47 PM
...
(45, 6, '', 'Topak', '', '110/70', '5', '1', '36.6', '61', '3', '', '', '', 'Joselito.Batumbakal', '2022-02-03');
...
(5, 1, '2022-02-03', 'Pabalan', 'Emmillian', 'D', '15 Goldstone Road Pilar Village Las Piñas City', 44, '1977-05-30', 'Manila', 'Married', 'Female', '09162852868', 'Catholic', 'Online Seller', 'Feb', '2022');
...
(40, 'Raphael.Garcia', 'Psychiatrist', '2022-02-03 05:55:27'),
(41, 'Joselito.Batumbakal', 'Dermatologist', '2022-02-03 07:05:46'),
(42, 'Jenny.Benedict', 'Surgeon', '2022-02-03 11:32:19'),
(43, 'Alberna.Benedict', 'Gynecologist', '2022-02-03 11:33:47'),
(44, 'Celine.Darna', 'Gynecologist', '2022-02-03 11:35:40'),
(45, 'B.Elmer', 'Gynecologist', '2022-02-03 11:38:52');
...
CREATE TABLE `standardusers` (
  ...
  `su_lname` varchar(255) NOT NULL,
  `su_email` varchar(255) NOT NULL,
  `su_position` varchar(255) NOT NULL,
  `su_status` enum('Pending','Verified') DEFAULT NULL,
  `su_verifkey` varchar(45) DEFAULT NULL,
...
INSERT INTO `standardusers` (`su_id`, `su_userid`, `su_user`, `su_pass`, `su_fname`, `su_lname`, `su_email`, `su_position`, `su_status`, `su_verifkey`, `date_created`) VALUES
(47, 1, 'marilyn', '$2y$12$i1smyg0fT4rbFFiocy58lOaRFj/g7.TPwSBznxhyuyTWXqurPkW/C', 'Marilyn', '', '', 'Doctor', 'Pending', '0', '2019-04-28 10:48:51'),
(49, 1, 'noa', '$2y$12$QrsjNiuyC8dQTg3k/FfVxO2at6mEEocVuMKSXBnDlri0rLaKFh47q', 'Noa', '', '', 'Doctor', 'Pending', '0', '2019-04-29 01:43:49'),
(53, 1, 'jobelle', '$2y$12$7ryPDjB4QM5RJzH3tcyu.uEEe82Is0Mq5eX3rmuKSkIBOsSpa49CC', 'Jobelle', '', '', 'Doctor', 'Pending', '0', '2019-05-01 06:49:30'),
(54, 1, 'gabriel', '$2y$12$Dk9NNuBkqv9WvPwNJp9BuOYySQdfpvxkv9rtcDGwl9XTCALPIvgsi', 'Gabriel', '', '', 'Doctor', 'Pending', '0', '2019-05-01 16:52:10'),
(55, 1, 'a', '$2y$12$BSWjDKrXXigrpX/TJpuQnu4qTBrtzXQ2DCLinVKZa6t6U3Lx0cjJC', 'A', '', '', 'Doctor', 'Pending', '0', '2022-01-26 08:14:21'),
(56, 1, 'rgarcia', '$2y$12$YnsXVsCPYReyoXSArop8fu4c9eGiKcTfZfRcmifGC.19zcacHuWeO', 'Raphael', '', '', 'Doctor', 'Pending', '0', '2022-02-03 05:56:09'),
(59, 1, 'joseph', '$2y$12$33gq6Je4o6co.8tZfg00rOkW65k4qZs.WCzKbTGabdVcwXSde79fm', 'Joseph', '', 'joseph@gmail.com', 'Doctor', 'Pending', '0', '2022-02-03 06:10:45'),
(60, 1, 'batums', '$2y$12$swCMmfzNY00j79mqpq7zWuDOfvJI73JMG1b7fpOxmPx45kprC4S4K', 'Joselito', '', '', 'Doctor', 'Pending', '0', '2022-02-03 07:07:10'),
(61, 1, 'jammy', '$2y$12$zwCwbc5KAmE5mD9j605uAOXpSSIbZj4t8E76Z.a/j6519OnfKaNWm', 'Jammy', ' Andrada', '', 'Doctor', NULL, NULL, '2022-02-03 07:44:57'),
(62, 1, 'jenny', '$2y$12$T6oRTWXMgvPoLCLOYdR0.OTym3gPAQKln45Kcqh0nM/TcMvjz8jgK', 'Jenny', 'Benedict', '', 'Doctor', NULL, NULL, '2022-02-03 11:32:07'),
(64, 1, 'darna', '$2y$12$P53ioQ10EJp1wL8t/pRt6eQnclwg2H4YPUUVlkpmEssx8e6LltPo2', 'Celine', 'Darna', '', 'Doctor', NULL, NULL, '2022-02-03 11:35:52'),
(65, 1, 'brady', '$2y$12$5aimP0XXY1uAvzBWpzLIM.upI8vRTp2OBsqYPyT5oQE2rppMMvdMu', 'Celine', 'Darna', '', 'Doctor', NULL, NULL, '2022-02-03 11:37:20'),
(66, 1, 'B', '$2y$12$Qb.nEamkrcp/2Y3XMt5my.TFXPbF0qFFkFtoszBPMuMfZC0.CG77y', 'B', 'Elmer', '', 'Doctor', NULL, NULL, '2022-02-03 11:39:05'),
(67, 1, 'c', '$2y$12$M9.53JiyVAijzaeR8P8lbOfvQCBNQPVsVfh80sxS4FnCqM0jI.K26', 'B', 'Elmer', '', 'Doctor', NULL, NULL, '2022-02-03 11:40:24');
...
--
ALTER TABLE `standardusers`
  MODIFY `su_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
